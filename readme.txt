...
Installing "MSR_WP_Plugin" can be done either by searching for "MSR_WP_Plugin" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
